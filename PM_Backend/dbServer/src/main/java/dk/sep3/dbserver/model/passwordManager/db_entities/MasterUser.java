...
@Table(name="\"masteruser\"") // Tells Spring Boot JPA, what the name of this database table is.
public class MasterUser implements Serializable
{
  ...
  @SequenceGenerator(name = "masteruser_id_generator", sequenceName = "masteruser_id_seq", allocationSize = 1)
  private int id;

  @Column (name = "masterusername", nullable=false) // Tells Spring Boot, that this variable has a column with the name "masterusername" in the database, and that values in this cannot be null.
