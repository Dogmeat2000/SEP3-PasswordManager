...
public class GrpcIntegrationTests
{
  ...
  public void testHandleGenericRequest_ReadLoginEntries_ReturnsStatusCode200() {
    ...
    MasterUserDTO createMasterUserResponse = discoveryPasswordManagerStub.handleRequest(request).getMasterUser();
    ...
    loginEntryDTO1 = discoveryPasswordManagerStub.handleRequest(request1).getLoginEntry();
    loginEntryDTO2 = discoveryPasswordManagerStub.handleRequest(request2).getLoginEntry();
    loginEntryDTO3 = discoveryPasswordManagerStub.handleRequest(request3).getLoginEntry();
